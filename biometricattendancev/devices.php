...
<main>
	<h1 class="slideInDown animated" style="color:white;">New Device Add/update/remove/Enable/Disable</h1>
	...
	<section class="container py-lg-5">
		...
		<div class="row">
			<div class="col-lg-12 mt-4">
				<div class="panel">
			      <div class="panel-heading" style="font-size: 19px;"> Devices:
			      	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#new-device" style="font-size: 18px; float: right; margin-top: -6px;">Add Device</button>
			      </div>
