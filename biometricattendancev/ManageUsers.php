...
<main>
	...
	<div class="form-style-5" style="opacity:0.8;width:95%;height:
	320px;">
	<div class="col-lg-6">
		<form enctype="multipart/form-data">
			...
			<legend><span class="number">1</span> User Fingerprint:</legend>
				<label>Enter Fingerprint ID</label>
				<input type="number" name="fingerid" id="fingerid" placeholder="User Fingerprint ID...">
				<button type="button" name="fingerid_add" class="fingerid_add btn btn-danger">Add ID</button>
			</fieldset>
			<div class="alert">
