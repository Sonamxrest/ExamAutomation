...
public class Login extends javax.swing.JFrame {
    ...
    public void log() {
        ...
        try {
            String query = "Select * from register where student_id=? && password=?";
            ...
            if (rs.next()) {
                ...
                String x = rs.getString(4) + " " + rs.getString(5);
                String id = rs.getString(3);
                String dob = rs.getString(7);
                String gender = rs.getString(6);

                AfterLog g = new AfterLog(x, id, dob, gender, c);
                g.setVisible(true);
